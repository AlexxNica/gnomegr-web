...
<hr class="bottom_shadow">
		...
		<?php
                    ...
                    echo '<ul class="quick_text">';
                    foreach ($custom_fields as $key => $url_array) {
                        if (strpos($key, 'quick_') !== false) {
                            
                            $parsed_key = substr($key, strlen('quick_'));
                            if (array_key_exists($parsed_key, $applications_quick_text)) {
                                foreach ($url_array as $url) {
                                    echo '<li><strong>'.$applications_quick_text[$parsed_key].' </strong><p> '.$url.'</p></li>';
                                }
                            }
                        }
