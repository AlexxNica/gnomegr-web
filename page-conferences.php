    ...
    <div id="container">
        <div class="container_12">
           ...
           <?php while ( have_posts() ) : the_post(); ?>
                <div class="main_header"><?php the_content(); ?></div>
            <?php endwhile; // End the loop. Whew. ?>
                ...
                ?>
                <p class="main_header">Εκδηλώσεις ή συνέδρια που αφορούν το GNOME και την ελληνική κοινότητα του.Θα βρείτε υλικό από τα συνέδρια,φωτογραφίες και αρχεία παρουσιάσεων όπως επίσης και τα άτομα που εκπροσώπησαν την ελληνική κοινότητα του GNOME.
</p>
                <hr class="top_shadow" />
